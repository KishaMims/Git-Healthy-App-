    ...
    <div className="Recipelist">
      {!recipes ? (<h2 className='checking'>
        ...
        Ready to eat? Search for a recipie based on your calorie needs.{" "} </h2>) : (
          <>
          <CardGroup>
          <Card border="success" className="recipe_list" >
            <Card.Body>
              ...
              <a href={recipes.meals[0].sourceUrl}>Go to Recipe!</a>
            </Card.Body>
          </Card>
          <Card border="success" className="recipe_list" >
              <Card.Body>
                ...
                <a href={recipes.meals[1].sourceUrl}>Go to Recipe!</a>
              </Card.Body>
            </Card>
            <Card border="success" className="recipe_list" >
            <Card.Body>
              ...
              <a href={recipes.meals[2].sourceUrl}>Go to Recipe!</a>
            </Card.Body>
          </Card>
          </CardGroup>
          </>     
